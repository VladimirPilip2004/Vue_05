<template>
    <div>
        ...
        <p class="blogDetails__mid__content__right__text">Contrary to popular belief.There are many variations of passages
            of
...
.blogDetails__mid__content__right__header {
    color: #292F36;
...
.blogDetails__mid__content__right__text {
    color: #4D5053;
